...
const Navbar = ({location})=>{
    ...
    return(
        <Bottomnav>
            ...
            <List className='profile' current={location.pathname === '/profile'}><Link to='/profile'><Logo className="Home" src={location.pathname === '/profile' ? user_icon_fill : user_icon} alt="home icon"/>프로필</Link></List>
        </Bottomnav>
    )
}
