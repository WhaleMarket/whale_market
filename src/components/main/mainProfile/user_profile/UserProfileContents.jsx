        ...
        <>
            <UserProfileContainer>
                ...
                <ProfileWrapper>
                    ...
                    >
                        <FollowCount>
                            {PostingState.data[0].user.followerCount}
                        </FollowCount>
                        <FollowTxt>followers</FollowTxt>
                    </Followers>
                    <ImgDiv
                        src={
                            PostingState.data[0].user.image !==
                                `${API_URL}/undefined` &&
                            PostingState.data[0].user.image?.includes(API_URL)
                                ? PostingState.data[0].user.image
                                : basic_profile_image
                        }
                    />
                    ...
                    >
                        <FollowCount>
                            {PostingState.data[0].user.followingCount}
                        </FollowCount>
